...
{#if form?.success}
	<article class="pico-background-green-550">
		<span>
			You have been successfully signed up. You should receive an email shortly to verify your email
			address and complete the sign up process.
		</span>
		<button class="pico-background-green-550" on:click={dismiss}>
			<Icon icon="x-lg" style="bootstrap" />
		</button>
	</article>
{/if}
...
<form method="POST" use:enhance={submit}>
	...
	<button aria-busy={busy} type="submit">Sign Up</button>
</form>
